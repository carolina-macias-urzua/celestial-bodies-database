...
COPY public.element (element_id, name, symbol, atomic_number, atomic_weight, is_noble_gas) FROM stdin;
1	Hydrogen	H	1	1.0080	f
2	Helium	He	2	4.0026	t
3	Lithium	Li	3	6.9400	f
\.
...
COPY public.galaxy (galaxy_id, name, description, age_in_millions_of_years, distance_from_earth, has_black_hole) FROM stdin;
1	Milky Way	Our home galaxy	13600	0.00	t
2	Andromeda	Spiral galaxy nearby	10000	2.53	t
3	Triangulum	Third largest in Local Group	12000	3.00	t
4	Sombrero	Unbarred spiral galaxy	13000	29.35	t
5	Whirlpool	Grand design spiral galaxy	400	23.00	t
6	Pinwheel	Face-on spiral galaxy	10000	20.87	t
\.
...
COPY public.moon (moon_id, planet_id, name, composition, orbital_period_days, diameter_km, is_spherical) FROM stdin;
1	3	Moon	Rock	27	3474.80	t
2	4	Phobos	Rock and Ice	0	22.50	f
3	4	Deimos	Rock and Ice	1	12.40	f
4	5	Io	Silicate Rock	2	3643.20	t
5	5	Europa	Silicate Rock & Ice	4	3121.60	t
6	5	Ganymede	Silicate & Ice	7	5268.20	t
7	5	Callisto	Rock and Ice	17	4820.60	t
8	6	Titan	Ice and Rock	16	5149.50	t
9	6	Enceladus	Ice	1	504.20	t
10	6	Mimas	Ice	1	396.40	t
11	6	Iapetus	Ice and Rock	79	1469.00	t
12	6	Rhea	Ice	5	1527.00	t
13	7	Titania	Ice and Rock	9	1577.80	t
14	7	Oberon	Ice and Rock	13	1522.80	t
15	7	Umbriel	Ice and Rock	4	1169.40	t
16	7	Ariel	Ice and Rock	3	1157.80	t
17	7	Miranda	Ice and Rock	1	471.60	t
18	8	Triton	Ice and Rock	6	2706.80	t
19	8	Proteus	Rock and Ice	1	420.00	f
20	8	Nereid	Ice	360	340.00	f
\.
...
COPY public.planet (planet_id, star_id, name, planet_type, number_of_moons, radius_km, has_life) FROM stdin;
1	1	Mercury	Terrestrial	0	2439.70	f
2	1	Venus	Terrestrial	0	6051.80	f
3	1	Earth	Terrestrial	1	6371.00	t
4	1	Mars	Terrestrial	2	3389.50	f
5	1	Jupiter	Gas Giant	95	69911.00	f
6	1	Saturn	Gas Giant	146	58232.00	f
7	1	Uranus	Ice Giant	28	25362.00	f
8	1	Neptune	Ice Giant	16	24622.00	f
9	2	Proxima b	Terrestrial	0	7000.00	f
10	2	Proxima c	Super-Earth	0	9000.00	f
11	3	Sirius b Planet Alpha	Exoplanet	0	5000.00	f
12	4	Andromeda Prime	Exoplanet	5	12000.00	f
\.
...
COPY public.star (star_id, galaxy_id, name, spectral_type, age_in_millions_of_years, mass_solar_masses, is_spherical) FROM stdin;
1	1	Sun	G2V	4600	1.00	t
2	1	Proxima Centauri	M5.5Ve	4850	0.12	t
3	1	Sirius	A1V	242	2.06	t
4	2	Andromeda Alpha	B8III	300	3.80	t
5	3	Triangulum Star A	O9V	100	15.00	t
6	4	Sombrero Central	K0III	8000	1.20	t
\.
